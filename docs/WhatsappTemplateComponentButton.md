...
**AppDeepLink** | Pointer to [**WhatsappTemplateComponentButtonAppDeepLink**](WhatsappTemplateComponentButtonAppDeepLink.md) |  | [optional] 
...
GetAppDeepLink returns the AppDeepLink field if non-nil, zero value otherwise.

### GetAppDeepLinkOk

`func (o *WhatsappTemplateComponentButton) GetAppDeepLinkOk() (*WhatsappTemplateComponentButtonAppDeepLink, bool)`

GetAppDeepLinkOk returns a tuple with the AppDeepLink field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetAppDeepLink sets AppDeepLink field to given value.
