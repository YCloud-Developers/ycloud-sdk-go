...
type WhatsappMessageTemplateComponent struct {
	...
	Cards []WhatsappMessageTemplateComponentCard `json:"cards,omitempty"`
}
...
func (o *WhatsappMessageTemplateComponent) GetCards() []WhatsappMessageTemplateComponentCard {
	if o == nil || o.Cards == nil {
		var ret []WhatsappMessageTemplateComponentCard
		return ret
	}
	return o.Cards
}
...
// SetCards gets a reference to the given []WhatsappMessageTemplateComponentCard and assigns it to the Cards field.
